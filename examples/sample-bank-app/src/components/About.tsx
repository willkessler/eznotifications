...
export const About = () => {
    return (
      ...
      <Group justify="space-between" mt="md" mb="xs">
        <Text size="xl" fw={1000}>Welcome to the: This Is Not A Drill! (TINAD) Playground</Text>
      </Group>

      <Text size="lg" c="dimmed" p="xs">
        <Text size="md">This playground provides a simulated web application for a regional bank. 
        ...
        The links in the left bar, e.g. <Text span fw={800}>Pay Your Bills</Text>, will display a specific notification tied to that pageId in the TINAD dashboard.<br /><br />
