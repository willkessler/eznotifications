...
const NotificationsList = () => {
  ...
  rows = notifications.map((row, index) => (
      ...
      <Table.Td className={classes.tableCellToTop}>
          Page: <Text size="sm" style={{ margin:'2px', padding:'2px 4px 2px 4px', backgroundColor:'#559', border: '1px dotted #aaa'}} span className={classes.pageId}>{row.pageId ? row.pageId : 'Any'}</Text><br/>
